        ...
        <header className="header">
            <div className="header__container">
                <ul className="header__menu">
                    ...
                    <li className="header__menu-item">
                        <a onClick={() => window.scrollTo(0, 0)} className="header__menu-link" to="/">ДОСТАВКА</a>
                        <div className="menu-underline"></div>
                    </li>
                    <li className="header__menu-item">
                        <a onClick={() => window.scrollTo(0, 0)} className="header__menu-link" to="/">КОНТАКТЫ</a>
                        <div className="menu-underline"></div>
                    </li>
                </ul>
                ...
                <div className="header__number ">
                    <p className="header__number-number">+7 (999) 929 28-79</p>
